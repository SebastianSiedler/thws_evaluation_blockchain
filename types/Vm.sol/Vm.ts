...
export interface Vm extends BaseContract {
  ...
  getScriptWallets: TypedContractMethod<[], [string[]], "nonpayable">;
  ...
  setArbitraryStorage: TypedContractMethod<
    [target: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "getScriptWallets"
  ...
  >;
  getFunction(
    nameOrSignature: "setArbitraryStorage"
